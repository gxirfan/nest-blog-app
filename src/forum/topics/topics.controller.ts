...
export class TopicsController {
  ...
  async createTopic(
    ...
    return TopicMapper.toSingleResponseDto(
      await this.topicsService.createTopic(req.user.id, createTopicDto),
    );
  }
  ...
  async findOneByTagId(
    ...
    return TopicMapper.toResponseDto(
  ...
  async updateOneById(
    ...
    return TopicMapper.toSingleResponseDto(
      await this.topicsService.updateOneById(id, req.user.id, updateTopicDto),
    );
  }
}
